        ...
        <div className="container-modal">
                ...
                data[index].pm10Value ? (
                  <>
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor:
                          data[index].pm10Value[0] <= 30
                            ? "#32A1FF"
                            : data[index].pm10Value[0] <= 80
                            ? "#7ACF17"
                            : data[index].pm10Value[0] <= 150
                            ? "#FD934C"
                            : "#FF7170",
                      }}
                    >
                      {data[index].pm10Value[0]}
                    </div>
                  </>
                ) : (
                  <div>데이터 로딩중...</div>
          ...
          <div className="behavior">
            ...
            <div className="textbox">
              ...
              {
                "공기가 탁하니 가급적 외출을 자제하세요\n외출 시 마스크나 손수건을 챙겨주세요\n노약자, 호흡기 질환자는 실외활동을 자제하세요\n미세먼지 마스크는 피부에 밀착시켜 착용하세요"
              }
            </div>
            <div className="textbox">
